...
const EditItem = props => {
    ...
    useEffect(() => {
			axios
				.get(`https://tech-stuff-tt72.herokuapp.com/api/posts/${itemId}`)
				.then((res) => {
    ...
    const formSubmit = (e) => {
        ...
        axiosWithAuth()
            .put(`https://tech-stuff-tt72.herokuapp.com/api/posts/${itemId}`, {name: formState.name, image_url: formState.image_url, category_id: formState.category_id, description: formState.description, user_id: userId})
            .then(res => {
